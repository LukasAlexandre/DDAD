...
> Toda sugestão de commit semântico em feedbacks e prompts da DDAD segue este padrão. Nenhum commit é feito sem confirmação explícita do usuário — ver `Docs/00_ddad/regras_ddad.md`, regra 6.
