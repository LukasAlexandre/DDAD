...
> Blocos desta sessão. Gerados via `ddat block create "<nome>" --session <sessao>`.
...
Consulte `04_planning/plano_execucao.md` para a ordem e dependência entre os blocos planejados.
